...
List students = [
  {"id": 1, "name": "John Doe", "class": 11},
  {"id": 2, "name": "Smith", "class": 12}
];
...
manageStudents() {
  ...
  while (true) {
    if(choice == "1"){ addStudent(); break;}

    else if(choice == "2") { viewStudents(); break;}

    else if(choice == "3") { updateStudent(); break; }

    else if(choice == "4") { deleteStudent(); break; }

    else if(choice == "5") { main(); break;}
...
viewStudents(){
  ...
  if (students.isEmpty == true) {
    ...
    print("ID : ${element["id"]}, Name : ${element["name"]}, Class : ${element["class"]}");
  }
  }
