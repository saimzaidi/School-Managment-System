...
List students = [
  {"id": 1, "name": "Saim", "class": 11},
  {"id": 2, "name": "Raza", "class": 12}
];
...
manageTeachers() {
  ...
  while (true) {
    if(choice == "1"){ addTeacher(); break;}

    else if(choice == "2") { viewTeachers(); break;}

    else if(choice == "3") { updateTeacher(); break; }

    else if(choice == "4") { deleteTeacher(); break; }
